...
const quizDataArabic = {
  ...
  "الفصل الثاني: بيئة التخزين و RAID": [
    {
  ...
  "الفصل الثالث: مقدمة وهياكل الكمبيوتر الأساسية": [
    {
  ...
  "الفصل السادس: مقدمة في المقايضات في ISA": [
    {
  ...
  "الفصل الثامن: البنية الدقيقة ذات الدورة الواحدة": [
    {
  ...
  "الفصل التاسع: البنية الدقيقة متعددة الدورات والخطية": [
    {
  ...
  "الفصل العاشر: مقدمة في البنية الدقيقة": [
    {
...
const chapterMapping = {
  ...
  "Chapter 2: Storage Environment and RAID": "الفصل 2: بيئة التخزين وRAID",
  "Chapter 3: Computer Architecture Introduction and Basics": "الفصل 3: مقدمة في بنية الكمبيوتر وأساسياته",
  ...
  "Chapter 6: Introduction to ISA Tradeoffs": "الفصل 6: مقدمة لمفاضلات ISA",
  "Chapter 7: ISA Tradeoffs afterlecture": "الفصل 7: مفاضلات ISA (بعد المحاضرة)",
  "Chapter 8: Single-Cycle Microarchitecture": "الفصل 8: البنية الدقيقة أحادية الدورة",
  "Chapter 9: Multi-Cycle and Pipelined Microarchitecture": "الفصل 9: البنية الدقيقة متعددة الدورات والأنبوبية",
  "Chapter 10: Introduction to Microarchitecture": "الفصل 10: مقدمة إلى البنية الدقيقة"
};
